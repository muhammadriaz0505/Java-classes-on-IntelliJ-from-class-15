...
class MathTeacher extends Teacher{
    ...
    public void teachesMath(){
        System.out.println(name+" "+" Teachs Math and hes favourite math subject is "+favoriteMathSubject);
    }
}
class ChemistryTeacher extends Teacher{
    String favoriteChemSubject;
    public void teachesChemistry(){
        System.out.println(name+" Teaches Chemistry and his favorite Chemistry ");
    }
}
